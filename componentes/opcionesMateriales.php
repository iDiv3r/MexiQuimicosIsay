        ...
        <form action="../php/controller.php" method="POST">   
            ...
            <table class="table">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="form-control" name="txtMedidaEdit" value="<?php echo $arregloMateriales2['medida']?>">
                    </td>
                </tr>
                </tbody>
            </table>
                ...
                <div class="table-responsive">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <input type="text" class="form-control" name="txtMedidaVt"  value="<?php echo  $arregloMateriales2['medida']?>" readonly>
                            </td>
                        </tr>
                    </tbody>
                    </table>
            ...
            <div class="modal-body">
                <form method="POST" action="../php/controller.php"> 
                    ...
                    <div class="modal-footer">
                        <input type="hidden" name="txtIdMaterial" value="<?php echo $arregloMateriales2['id']; ?>"> 
                        <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Cancelar</button>
                        <button type="submit" class="btn btn-success" name="btnEliminarMaterial">Si</button>
                    </div>
                </form>
            </div>
        </div>
